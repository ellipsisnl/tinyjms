...
public class TinyJmsSession implements Session, QueueSession, TopicSession
{
	...
	public Topic createTopic(String topicName) throws JMSException {
		...
		Topic topic = new TinyJmsTopic(topicName);
	...
	{
		return new TinyJmsTopicPublisher(topic);
	}

	@Override
	public TopicSubscriber createSubscriber(Topic topic, String messageSelector, boolean noLocal) throws JMSException
	{
		return new TinyJmsTopicSubscriber(topic,messageSelector,noLocal);
	}
