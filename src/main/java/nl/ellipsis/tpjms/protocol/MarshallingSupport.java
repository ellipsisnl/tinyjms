...
/**
 * Marshalling support for TPJMS objects.
 */
public final class MarshallingSupport {
	...
	public static void marshalMap(DataOutputStream dos, Map<String, Object> map)
			throws JMSException {
		try {
	...
	public static void unmarshalMap(DataInputStream dis, Map<String, Object> map)
			throws JMSException {
		try {
	...
	public static Object unmarshalObject(DataInputStream dis)
			throws JMSException {
		try {
			// read ordinal
			...
			if (type == null) {
				throw new MessageFormatException("Invalid type read: "
						+ ordinal);
			}
	...
	public static void marshalObject(DataOutputStream dos, Object value)
			throws JMSException {
		try {
			if (value == null) {
	...
	private static byte[] unmarshalBytes(DataInputStream dis)
			throws IOException {
