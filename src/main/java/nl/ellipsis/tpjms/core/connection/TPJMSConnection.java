...
public class TPJMSConnection implements Connection, QueueConnection, TopicConnection {
	...
	private final TPJMSProvider provider;
	private final TPJMSConnectionContext context;
	 ...
	 * dynamically by the application by calling the
	 * {@link #setClientID(String)} method.
	 * </p>
	 * 
	...
	public ConnectionMetaData getMetaData() throws JMSException {
		...
		return new TPJMSConnectionMetaData();
	}
	 ...
	 * {@link IllegalStateException}. If a client sets the client identifier
	 * explicitly, it must do so immediately after it creates the connection and
	 * before any other action on the connection is taken. After this point,
	 * setting the client identifier is a programming error that should throw an
	 ...
	 * throw an InvalidClientIDException.
	 * <p>
	 * 
	 * @param clientID
	...
	/**
	 * @see #createConnectionConsumer(Destination, String, ServerSessionPool,
	 *      int)
	 */
	@Override
