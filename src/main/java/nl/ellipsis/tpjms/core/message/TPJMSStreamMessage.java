...
import nl.ellipsis.tpjms.protocol.MarshallingSupport.ObjectType;

/**
 * TPJMS implementation of {@link StreamMessage}.
 */
public class TPJMSStreamMessage extends TPJMSMessage implements StreamMessage {
	 ...
	 * 
	 * <p>
	 * If the byte array field value is <code>null</code>,
	 * <code>readBytes</code> returns -1.
	 * </p>
	 * 
	 * <p>
	...
	public int readBytes(byte[] value) throws JMSException {
		...
		int bytesToRead = Math.min(value.length, byteField.length
				- byteFieldPos);
	...
	private void checkByteReadInProgress() throws MessageFormatException {
		if (byteField != null) {
			throw new MessageFormatException(
					"Previous read of byte array is not complete");
		}
	}
