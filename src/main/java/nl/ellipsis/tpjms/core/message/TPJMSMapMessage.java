...
import nl.ellipsis.tpjms.protocol.MarshallingSupport;

/**
 * TPJMS implementation of {@link MapMessage}.
 */
public class TPJMSMapMessage extends TPJMSMessage implements MapMessage {
	 ...
	 *         is no item by this name, a <code>null</code> value is returned.
	 * @throws JMSException
	 *             if the JMS provider fails to read the message due to some
	 *             internal error.
	 * @throws MessageFormatException
	...
	public byte[] getBytes(String name) throws JMSException {
		...
		throw new MessageFormatException(
				"Unsupported conversion to byte array from type: "
						+ value.getClass().getName());
	}
	...
	public char getChar(String name) throws JMSException {
		...
		if (value == null) {
			throw new NullPointerException(
					"Null value cannot be converted to char");
		}
		...
		throw new MessageFormatException(
				"Unsupported conversion to char from type: "
						+ value.getClass().getName());
	}
	...
	public Object getObject(String name) throws JMSException {
		...
		throw new JMSException("Invalid data type in map: "
				+ value.getClass().getName());
	}
	 ...
	 * @throws JMSException
	 *             if the JMS provider fails to determine if the item exists due
	 ...
	 *             specification which calls for
	 *             <code>NullPointerException</code> in order to make this
	 *             consistent with all other setters in this class.
	 * @throws MessageNotWriteableException
	 *             if the message is in read-only mode.
	 */
	@Override
	public void setBytes(String name, byte[] value) throws JMSException {
		checkName(name); // JMS 1.1 calls for NPE here, but IAE is more
							// consistent
		checkReadOnly();
		byte[] copy = null;
		if (value != null) {
