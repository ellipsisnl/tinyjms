 ...
 */
public class TinyJmsMessageProducer implements MessageProducer
{
	private static final Logger logger = LogManager.getLogger(TinyJmsMessageProducer.class);
	...
	TinyJmsMessageProducer(Destination destination) throws JMSException
	{
